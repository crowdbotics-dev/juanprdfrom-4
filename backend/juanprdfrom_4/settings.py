"""
Django settings for juanprdfrom_4 project.
...
ROOT_URLCONF = 'juanprdfrom_4.urls'
...
WSGI_APPLICATION = 'juanprdfrom_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juanprdfrom_4 API",
    "DESCRIPTION": "API documentation for juanprdfrom_4 App",
    "VERSION": "v1",
}
